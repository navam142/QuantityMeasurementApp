package com.apps.quantitymeasurement.uc16.unit;
...
public enum TemperatureUnit implements IMeasurable {
    ...
    private final Function<Double, Double> FAHRENHEIT_TO_CELSIUS = f -> (f - 32) * 5 / 9;
    private final Function<Double, Double> CELSIUS_TO_CELSIUS = c -> c;
    private final Function<Double, Double> CELSIUS_TO_FAHRENHEIT = c -> (c * 9 / 5) + 32;
